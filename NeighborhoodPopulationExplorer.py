...
if getattr(sys, 'frozen', False):
    # If the program is run as a PyInstaller bundle
    bundle_dir = sys._MEIPASS
else:
    # If the program is run as a normal Python script
    bundle_dir = os.path.dirname(os.path.abspath('BostonNeighborhoodData.json'))

with open(os.path.join(bundle_dir, 'BostonNeighborhoodData.json'), 'r') as f:
    data = json.load(f)
